...
export async function execute(interaction, client) {
  ...
  if (selectedBanType === "appealable") {
    embeds.description = `> You have been issued a **APPEALABLE BAN** from Greenville Community Roleplay, this is due to: **${BanReason}**.\n\n> \`\`Evidence:\`\`${evidenceURL}\n\n> If you believe this ban was false, please contact a member of the staff team to discuss about it.`;
    // Appealable Ban Format
  } else if (selectedBanType === "unappealable") {
    embeds.description = `> You have been issued a **UNAPPEALABLE BAN** from Greenville Community Roleplay, this is due to: **${BanReason}**.\n\n> \`\`Evidence:\`\`${evidenceURL}\n\n> If you believe this ban was false, please contact a member of the staff team to discuss about it.`;
